...
static const struct bt_data ad[] = {
	...
	BT_DATA_BYTES(BT_DATA_UUID128_ALL, BT_UUID_128_ENCODE(0x17DFAF86,0x8765,0x4A44,0xB6B8,0xC838F7FA5620)),
...
int main(void)
{
	...
	bt_service_cb_register(&service_cb);
